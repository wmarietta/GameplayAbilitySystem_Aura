...
public:
	...
	static void SetIsBlockedHit(UPARAM(ref) FGameplayEffectContextHandle& EffectContext, bool bInIsBlocked);
	...
	UFUNCTION(BlueprintCallable, Category = "AuraAbilitySystemLibrary|GameplayEffects")
	static void SetIsCriticalHit(UPARAM(ref) FGameplayEffectContextHandle& EffectContext, bool bInIsCritical);
