...
public:
	...
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_ArcaneResistance, Category = "Attributes|Secondary")
	...
	*/
	...
	UFUNCTION()
	void OnRep_FireResistance(const FGameplayAttributeData& OldManaRegeneration) const;
